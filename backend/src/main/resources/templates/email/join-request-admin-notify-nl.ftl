                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">
                                Er is een nieuwe lidmaatschapsaanvraag ingediend voor <strong>${orgName}</strong>.
                            </p>
                            ...
                            <div style="margin: 20px 0; padding: 16px; background-color: #f0fdf4; border-left: 4px solid #047857; border-radius: 4px;">
                                <p style="margin: 0 0 8px 0; color: #1f2937; font-size: 14px;">
                                    <strong>Aanvrager:</strong> ${requesterName}
                                </p>
                                <p style="margin: 0; color: #1f2937; font-size: 14px;">
                                    <strong>E-mail:</strong> ${requesterEmail}
                                </p>
                            </div>

                            <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">
                                Beoordeel deze aanvraag in het beheerpaneel en keur hem goed of af.
                            </p>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin: 30px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="${adminUrl}" style="display: inline-block; padding: 16px 40px; background-color: #047857; color: #ffffff; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: 600;">
                                            Aanvraag Beoordelen
                                        </a>
                                    </td>
                                </tr>
