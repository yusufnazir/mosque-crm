  ...
  useEffect(() => {
    generalEventApi.getEvent(id).then(ev => {
      setForm({
        ...
        // DateInput expects yyyy-MM-dd (API returns LocalDateTime)
        registrationOpenDate: ev.registrationOpenDate ? ev.registrationOpenDate.slice(0, 10) : '',
        registrationCloseDate: ev.registrationCloseDate ? ev.registrationCloseDate.slice(0, 10) : '',
        ...
        publicFormShowPhone: ev.publicFormShowPhone ?? true,
        publicFormShowPartySize: ev.publicFormShowPartySize ?? false,
        publicFormShowSpecialRequests: ev.publicFormShowSpecialRequests ?? true,
