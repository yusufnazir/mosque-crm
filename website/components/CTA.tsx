...
export default async function CTA({ getStartedUrl = '#contact' }: CTAProps) {
    ...
    <section className="py-24 lg:py-32 bg-primary relative overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display font-bold text-white leading-tight">
          {t('titleLine1')}
          <span className="block text-gold">{t('titleLine2')}</span>
        </h2>
        <p className="mt-6 text-lg text-white max-w-2xl mx-auto">{t('subtitle')}</p>

        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          <a
            href={getStartedUrl}
            {...externalLinkProps(getStartedUrl)}
