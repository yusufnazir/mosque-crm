...
export default async function Hero() {
  ...
  const stats = [
    { label: t('statTotalMembers'), value: '1,247', color: 'text-emerald-deep', bg: 'bg-emerald-subtle' },
    { label: t('statActiveFamilies'), value: '389', color: 'text-sky-600', bg: 'bg-sky-50' },
    { label: t('statThisMonth'), value: '$12,480', color: 'text-gold', bg: 'bg-amber-50' },
    { label: t('statEvents'), value: '3', color: 'text-violet-600', bg: 'bg-violet-50' },
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="mt-16 flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-charcoal-light">{t('socialProof')}</p>
          </div>
        </div>
            ...
            <div className="p-6 sm:p-8 bg-gradient-to-br from-stone-50 to-white min-h-[300px] lg:min-h-[400px]">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
                <div className="lg:col-span-2 bg-white rounded-xl border border-stone-200 p-4">
                  <p className="text-sm font-semibold text-charcoal mb-3">{t('chartTitle')}</p>
                ...
                <div className="bg-white rounded-xl border border-stone-200 p-4">
                  <p className="text-sm font-semibold text-charcoal mb-3">{t('recentMembers')}</p>
